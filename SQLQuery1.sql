CREATE TABLE [dbo].[Reservation] (
    ...
    CONSTRAINT [FK_Reservation_Room] FOREIGN KEY ([IdRoom]) REFERENCES [dbo].[Room]([IdRoom])
);
...
CREATE TABLE [dbo].[ReservationDetails] (
    ...
    CONSTRAINT [FK_ReservationD_Reserv] FOREIGN KEY ([IdReservation]) REFERENCES [dbo].[Reservation]([IdReservation])
);